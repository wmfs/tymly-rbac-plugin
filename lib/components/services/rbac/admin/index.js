...
class RbacAdmin {
  ...
  restrictionsOn(resourceType, resourceName) {
    const resourceTypeRestrictions = this.rbac.index[resourceType] || { }

    const specificRestrictions = resourceTypeRestrictions[resourceName] || { }
    const genericRestrictions = resourceTypeRestrictions['*'] || { }
