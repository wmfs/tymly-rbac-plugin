...
class RbacAdmin {
  ...
  ensureUserRoles (userId, roleIds) {
    return ensureUserRoles(userId, roleIds, this.roleMembershipModel, this.rbacService.logger)
  } // ensureUserRoles
  ...
  async createRole (roleId, label, description, inherits) {
    ...
    await ensureRoleRoles(roleId, inherits, this.roleMembershipModel, this.rbacService.logger)
  } // createRole
